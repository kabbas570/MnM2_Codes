...
path_to_save_Learning_Curve='/data/home/acw676/MM/weights/'+'/unets2'
path_to_save_check_points='/data/home/acw676/MM/weights/'+'/unets2'
...
train_loader = Data_Loader_(df_train,train_imgs,batch_size)

val_loader = Data_Loader_(df_val,val_imgs,batch_size)
