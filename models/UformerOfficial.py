"""
Uformer model code downloaded from official Uformer repository at: 
https://github.com/ZhendongWang6/Uformer/blob/main/model.py

Changes made by muhammad asad (masadcv@gmail.com) (2023-01-19):
- Remove dependency torch_dwconv, in favour of depthwise conv2d implemented using nn.Conv2d
- Change FastLeFF module to remove torch_dwconv dependency, and utilise nn.Conv2d for implementing depthwise conv2d
...
class FastLeFF(nn.Module):
    ...
    def __init__(self, dim=32, hidden_dim=128, act_layer=nn.GELU,drop = 0.):
        ...
        # self.dwconv = nn.Sequential(DepthwiseConv2d(hidden_dim, hidden_dim, kernel_size=3,stride=1,padding=1),
                        # act_layer())
        # Depthwise Conv2d using pytorch Conv2d, help from: 
        # https://discuss.pytorch.org/t/how-to-modify-a-conv2d-to-depthwise-separable-convolution/15843/3
